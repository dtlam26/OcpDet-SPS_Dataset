...
class SSDMobileNetV2LearningLossKerasFeatureExtractor(
    ssd_meta_arch.SSDKerasFeatureExtractor):
  """SSD Feature Extractor using MobilenetV2 features with learning loss"""
  ...
  def __init__(self,
    ...
    """
    super(SSDMobileNetV2LearningLossKerasFeatureExtractor, self).__init__(
    ...
    self._feature_map_layout = {
        ...
        'layer_depth': [576,1280, 512, 256, 256, 128][:self._num_layers],
        'layer_kernel': [19,10,5,3,2,1][:self._num_layers],
