  ...
  def _predict(self, image_features, **kwargs):
    ...
    for (index, image_feature) in enumerate(image_features):
      ...
      box_tower_feature = _apply_layers(
          ...
          image_feature)
      # if 'active_anchors' in kwargs:
      #   box_encodings = self._box_prediction_head(box_tower_feature,active_anchor=kwargs['active_anchors'][index])
      # else:
      ...
      for head_name in self._sorted_head_names:
        ...
        if self._share_prediction_tower:
          ...
          head_tower_feature = _apply_layers(
              ...
              image_feature)
        if 'active_anchors' in kwargs and head_name =='class_predictions_with_background':
            print('Apply Active Anchors')
            prediction = head_obj(head_tower_feature,active_anchor=kwargs['active_anchors'][index])
        else:
