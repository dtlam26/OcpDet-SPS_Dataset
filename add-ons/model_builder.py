...
#learning_loss_custom
  from object_detection.models import ssd_mobilenet_v2_keras_learning_loss_feature_extractor
  from object_detection.models import ssd_mobilenet_fpn_keras_learning_loss_feature_extractor

#acnhor_actives
  from object_detection.models import ssd_mobilenet_fpn_keras_learning_loss_active_anchors_feature_extractor

#model_custom    
  from object_detection.models import ssd_resnet_feature_extractor
  from object_detection.models import ssd_vgg_feature_extractor
...
if tf_version.is_tf2():
  SSD_KERAS_FEATURE_EXTRACTOR_CLASS_MAP = {
      ...
      'ssd_resnet50_keras':
          ssd_resnet_feature_extractor.SSDResNet50V1KerasFeatureExtractor,
      'ssd_resnet34_keras':
          ssd_resnet_feature_extractor.SSDResNet34V1KerasFeatureExtractor,
      'ssd_vgg16_300_keras':
          ssd_vgg_feature_extractor.SSDVgg300KerasFeatureExtractor,
      'ssd_vgg16_512_keras':
          ssd_vgg_feature_extractor.SSDVgg512KerasFeatureExtractor,
      'ssd_mobilenet_v2_learning_loss_keras':
          ssd_mobilenet_v2_keras_learning_loss_feature_extractor.SSDMobileNetV2LearningLossKerasFeatureExtractor,
      'ssd_mobilenet_fpn_learning_loss_keras':
          ssd_mobilenet_fpn_keras_learning_loss_feature_extractor.SSDMobileNetV2FpnLearningLossKerasFeatureExtractor,
      'ssd_mobilenet_fpn_learning_loss_active_anchors_keras':
          ssd_mobilenet_fpn_keras_learning_loss_active_anchors_feature_extractor.SSDMobileNetV2FpnLearningLossKerasFeatureExtractor
  }
...
def _build_ssd_feature_extractor(feature_extractor_config,
  ...
  if 'active_anchors' in str(feature_type) and is_keras:
    print("ACTIVE_ANCHORS")
    kwargs.update({'active_anchors': preknown_anchors})
...
def _build_ssd_model(ssd_config, is_training, add_summaries):
  ...
  feature_extractor = _build_ssd_feature_extractor(
      ...
      preknown_anchors=anchor_generator)
...
def build(model_config, is_training, add_summaries=True):
  ...
  if meta_architecture not in META_ARCH_BUILDER_MAP:
    ...
    #builder as ssd or faster or center net etc...
